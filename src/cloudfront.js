...
const cloudfront = new AWS.CloudFront({ apiVersion: '2020-05-31', region:REGION })

// Cloudfront doc: https://docs.aws.amazon.com/AWSJavaScriptSDK/latest/AWS/CloudFront.html
const _createDistribution = promisify(cloudfront, 'createDistributionWithTags', true)
const _createInvalidation = promisify(cloudfront, 'createInvalidation', true)
const _getDistribution = promisify(cloudfront, 'getDistribution', true)
const _getDistributionConfig = promisify(cloudfront, 'getDistributionConfig', true)
const _updateDistribution = promisify(cloudfront, 'updateDistribution', true)
